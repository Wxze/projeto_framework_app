...
class PhysicalPersonListTile extends StatefulWidget {
  const PhysicalPersonListTile({super.key, required this.person, required this.resetPersonsListState});
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () async {
                                      if (formKey.currentState!.validate()) {
                                        Response resp = await PhysicalPersonRepository()
                                            .updatePerson(widget.person.id, _nameController.text, _cpfController.text, _salaryController.text);
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: ElevatedButton(
                                                        onPressed: () async {
                                                          Response resp = await PhysicalPersonRepository().deletePerson(widget.person.id);
